		...
		if not hidden then
			if v.type == "group" then
				...
				elseif v.type == "toggle" then
					...
					local--- AceConfigDialog-3.0 generates AceGUI-3.0 based windows based on option tables.
-- @class file
...
local function confirmPopup(appName, rootframe, basepath, info, message, func, ...)
	...
	if dialog then
		...
		dialog:SetFrameStrata("TOOLT imageCoords = GetOptionsMemberValue("imageCoords", v, options, path, appName)
